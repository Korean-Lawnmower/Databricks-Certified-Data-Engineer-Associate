...
spark.sql("describe orders_raw_temp").show()
...
# MAGIC   cast(from_unixtime(order_timestamp, 'yyyy-MM-dd HH:mm:ss') as timestamp) order_timestamp, books
# MAGIC
# MAGIC from orders_bronze_tmp o inner join customers_lookup c on o.customer_id = c.customer_id
# MAGIC where quantity > 0)
...
# MAGIC %sql
# MAGIC select count(*) from orders_enriched_tmp
...
# MAGIC %sql
# MAGIC describe history daily_customer_books
